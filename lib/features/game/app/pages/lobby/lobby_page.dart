...
// class AccusationPopUp extends StatefulWidget {
//   const AccusationPopUp({Key? key, required this.accusationType, required this.controller}) : super(key: key);
//   final AccusationType accusationType;
//   final LobbyController controller;

//   @override
//   State<AccusationPopUp> createState() => _AccusationPopUpState();
// }

// class _AccusationPopUpState extends State<AccusationPopUp> {
//   @override
//   Widget build(BuildContext context) {
//     return ControlledWidgetBuilder<LobbyController>(builder: ((context, controller) {
//       return Dialog(
//         child: Padding(
...
//               Text(
//                 widget.controller.topLieText(widget.accusationType),
...
//                     items: widget.controller.playersWithouthCurrentDropdownItems,
//                     onChanged: widget.controller.selectLieUser,
//                     hint: Container(
...
//               SizedBox(height: 2 * AppUI.heightUnit),
//               NumberPicker(
//                 value: widget.controller.lieDiceCount,
//                 axis: Axis.horizontal,
//                 minValue: 1,
//                 maxValue: widget.controller.totalDiceCount,
//                 step: 1,
//                 itemWidth: 10 * AppUI.widthUnit,
//                 haptics: true,
//                 onChanged: (value) => widget.controller.setDiceLieCount(value),
//               ),
//               SizedBox(height: 2 * AppUI.heightUnit),
//               const Text(
//                 "Dice Type",
...
//                                   color: widget.controller.selectedDiceType != null &&
//                                           widget.controller.selectedDiceType == index + 1
//                                       ? Colors.grey[600]
//                                       : null,
//                                 ),
...
//                                   ),
//                                   onTap: () => widget.controller.selectDiceType(index),
//                                 )),
//                           ))),
//               SizedBox(height: 4 * AppUI.heightUnit),
//               PrimaryButton(
//                 text: widget.controller.accuseButtonText(widget.accusationType),
//                 onTap: widget.controller.canAccuse ? () => widget.controller.accuse(widget.accusationType) : null,
//               )
//             ])),
//       );
//     }));
...
//                 context: context,
//                 builder: (context) =>
//                     AccusationPopUp(accusationType: AccusationType.standard, controller: lobbyController),
//               );
//             },
